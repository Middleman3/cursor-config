...
7. **Update project overview** (if the project has one)
   - Add the new service to the project’s overview doc or skill (e.g. `skills/project-overview/SKILL.md` in cursor-config) or the project’s own cursor config
